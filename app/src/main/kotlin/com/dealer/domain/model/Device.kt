...
class PlatformConverter : AttributeConverter<Platform, String> {
    override fun convertToDatabaseColumn(attribute: Platform?): String? =
        attribute?.toDbValue()

    override fun convertToEntityAttribute(dbData: String?): Platform? =
        dbData?.let { Platform.valueOf(it.uppercase()) }
}
